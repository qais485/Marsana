...
export default function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const result = await login(email, password, 'web-browser', 'web');
  ...
  const handleResendVerification = async () => {
    ...
    try {
      await authService.sendEmailVerification(unverifiedEmail);
      ...
      <div className="w-full max-w-md">
        <div className="bg-white dark:bg-surface-900 rounded-3xl shadow-xl p-6 sm:p-8 border border-surface-200 dark:border-surface-800">
          <div className="text-center mb-6 sm:mb-8">
            <div className="w-14 h-14 sm:w-16 sm:h-16 bg-amber-100 dark:bg-amber-900/30 rounded-2xl flex items-center justify-center mx-auto mb-4">
            ...
            <p className="text-surface-500 dark:text-surface-400 mt-2 text-sm sm:text-base">
              Your account <strong className="text-surface-900 dark:text-white">{unverifiedEmail}</strong> has not been verified yet.
            ...
            {resendSuccess && (
              <div className="bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-800 text-emerald-700 dark:text-emerald-400 px-4 py-3 rounded-xl mb-4 flex items-start gap-3">
            ...
            <button
              ...
              className="btn-marsana w-full mb-4"
            >
              {resending
                ? 'Sending...'
                : cooldown > 0
            ...
            <div className="text-center">
              <button
                ...
                className="text-sm text-surface-500 dark:text-surface-400 hover:text-marsana-600 dark:hover:text-marsana-400 transition-colors"
              >
                Back to login
              </button>
            </div>
        ...
        <div className="bg-white dark:bg-surface-900 rounded-3xl shadow-xl p-6 sm:p-8 border border-surface-200 dark:border-surface-800">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  ...
                  className="w-4 h-4 rounded border-surface-300 text-marsana-600 focus:ring-marsana-500/20"
                />
                <span className="text-sm text-surface-600 dark:text-surface-400">Remember me</span>
              </label>
              <Link to="/forgot-password" className="text-sm text-marsana-600 dark:text-marsana-400 hover:text-marsana-700 dark:hover:text-marsana-300 font-medium transition-colors">
                Forgot password?
              </Link>
            </div>
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 sm:grid-cols-3 gap-3">
              <button type="button" className="btn-outline !py-3 flex justify-center items-center hover:bg-surface-50 dark:hover:bg-surface-800 min-h-[44px]">
              ...
              <button type="button" className="btn-outline !py-3 flex justify-center items-center hover:bg-surface-50 dark:hover:bg-surface-800 min-h-[44px] col-span-2 sm:col-span-1">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <p className="mt-8 text-center text-sm text-surface-500 dark:text-surface-400">
            ...
            <Link to="/register" className="text-marsana-600 dark:text-marsana-400 hover:text-marsana-700 dark:hover:text-marsana-300 font-semibold transition-colors">
              Sign up
            </Link>
          </p>
        </div>
