...
export default function AdminHelpArticleForm({ article, onSave, onCancel }) {
  ...
  return (
    <div className="bg-white rounded-xl border border-surface-100 p-4 sm:p-6">
      <h3 className="text-base sm:text-lg font-semibold text-surface-900 mb-4">{isEdit ? 'Edit Article' : 'Create Article'}</h3>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <textarea
            ...
            required
            rows={12}
            className="w-full px-3 py-2 border border-surface-300 rounded-lg text-sm focus:ring-2 focus:ring-marsana-500 focus:border-marsana-500 font-mono"
